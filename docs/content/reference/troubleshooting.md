...
Most of these come down to network reality or how sunrisesunset serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sunrisesunset rate-limits like any public site. sunrisesunset already paces
...
Where a surface is gated, sunrisesunset reads a cookie or token you supply
...
`sunrisesunset`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sunrisesunset actually did
