// Package cli assembles the sunrisesunset command tree from the sunrisesunset
...
// NewApp assembles the kit application from the sunrisesunset domain. The
...
//
// To add a command, declare it in sunrisesunset/domain.go with kit.Handle and it
